...
- **2025-06-29 16:08**: Correction déploiement Koyeb - Package-lock.json créé, build command optimisé ("npm install && npm run build"), problème "Missing lockfile" résolu
