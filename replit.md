...
- **2025-06-29 17:01**: Correction script TypeScript pour déploiement Koyeb - Suppression postinstall (conflictuel), build direct avec 'tsc' au lieu de 'npx tsc', typescript installé comme dépendance
