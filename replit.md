...
- **2025-06-29 16:59**: Package-lock.json minimal créé pour satisfaire exigences Koyeb - Version simplifiée avec uniquement les dépendances principales sans sous-dépendances, script postinstall pour build automatique
