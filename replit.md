...
- **2025-06-29 16:54**: Configuration npm optimisée pour Koyeb - .npmrc avec package-lock=false et legacy-peer-deps=true, package-lock.json minimal, build intégré avec --legacy-peer-deps
