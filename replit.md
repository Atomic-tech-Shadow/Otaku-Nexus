...
- **2025-06-29 16:57**: Stratégie finale déploiement Koyeb - Suppression complète package-lock.json et .npmrc, scripts heroku-prebuild/heroku-postbuild avec npm install --no-package-lock pour forcer installation normale
