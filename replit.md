...
- **2025-06-29 16:22**: Dépendances transitives complétées - Package-lock.json maintenant inclut toutes les dépendances requises (@types/body-parser, pg-protocol, etc.), compatible npm ci
