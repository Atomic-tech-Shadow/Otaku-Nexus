  ...
  if (!animeData) {
    return (
      <MainLayout>
        <div className="flex items-center justify-center min-h-96">
          <div className="glass-morphism rounded-2xl p-6 text-center">
            <p className="text-gray-400">Anime non trouvé</p>
          </div>
        </div>
      </MainLayout>
    );
    ...
    <MainLayout>
      <div className="min-h-screen text-white">
        ...
        <div className="glass-morphism rounded-2xl p-6 mb-6">
          <h1 className="text-2xl font-bold text-nexus-cyan mb-2">{animeData.title}</h1>
          <Link href="/anime-sama" className="text-gray-400 hover:text-nexus-cyan transition-colors">
            ← Retour aux animes
          </Link>
        </div>
