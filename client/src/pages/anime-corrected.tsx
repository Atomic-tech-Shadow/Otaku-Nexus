                ...
                <div className="lg:col-span-2">
                  ...
                  {animeDetails.seasons && animeDetails.seasons.length > 0 && (
                    <Card className="mt-6 bg-white/10 border-white/20">
                      ...
                      <CardContent>
                        <div className="flex flex-wrap gap-2 mb-4">
                          {animeDetails.seasons.map((season: AnimeSamaSeason) => (
                            <Button
                              key={season.number}
                  ...
                  <Card className="bg-white/10 border-white/20">
                    ...
                    <CardContent className="space-y-4">
                      <div>
                        ...
                        <div className="text-white">{animeDetails.year}</div>
                      </div>
                      <div>
                        <div className="text-white/60 text-sm">Statut</div>
                        <div className="text-white">{animeDetails.status}</div>
                      </div>
                      <div>
                        <div className="text-white/60 text-sm">Saisons</div>
                        <div className="text-white">{animeDetails.seasons.length}</div>
                      </div>
                      <div>
